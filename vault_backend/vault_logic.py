...
class VaultManager:
  ...
  def query_results_check(self, results, filter, input):
    if not results:
      raise NoSetsFoundError(f"There are no sets in the vault with {filter} {input}.")
    return results
  ...
  def rm_set(self, set_trm):
    for  i, lego_set in enumerate(self.set_list):
      if lego_set.set_num == set_trm or lego_set.name == set_trm:
        self.set_list.pop(i)
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with set number or name {set_trm}.")
  ...
  def update_set_num(self, set_num, new_set_num):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with set number {set_num}.")
  ...
  def update_set_theme(self, set_num, new_theme):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with theme {set_num}.")
  ...
  def update_set_year(self, set_num, new_year):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with year {set_num}.")
  ...
  def update_set_status(self, set_num, new_status):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with status {set_num}.")
  ...
  def update_set_priority(self, set_num, new_priority):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with priority {set_num}.")
  ...
  def update_set_price(self, set_num, new_price):
    ...
    raise NoSetsFoundError(f"There are no sets in the vault with price {set_num}.")
  ...
  def update_set_pieces(self, set_num, new_pieces):
    for lego_set in self.set_list:
      if lego_set.set_num == set_num:
        ...
        return True
    raise NoSetsFoundError(f"There are no sets in the vault with pieces {set_num}.")
  ...
  def get_sbpr(self, min_price, max_price):
    result = [lego_set for lego_set in self.set_list if lego_set.price >= min_price and lego_set.price <= max_price]
    return self.query_results_check(result, "price", f"{min_price} and {max_price}")

  def get_sbpc(self, min_pieces, max_pieces):
    result = [lego_set for lego_set in self.set_list if lego_set.pieces >= min_pieces and lego_set.pieces <= max_pieces]
    return self.query_results_check(result, "piece count", f"{min_pieces} and {max_pieces}")

  def get_sbsbt(self, status):
    result = [lego_set for lego_set in self.set_list if lego_set.built_status == status]
    return self.query_results_check(result, "built status", status)
  ...
  def get_scbt(self, theme):
    results = len([lego_set for lego_set in self.set_list if lego_set.theme == theme])
  ...
  def get_scbpr(self, min_price, max_price):
    result = len([lego_set for lego_set in self.set_list if lego_set.price >= min_price and lego_set.price <= max_price])
    return self.count_results_check(result, "price", f"{min_price} and {max_price}")

  def get_scbpc(self, min_pieces, max_pieces):
    result = len([lego_set for lego_set in self.set_list if lego_set.pieces >= min_pieces and lego_set.pieces <= max_pieces])
    return self.count_results_check(result, "piece count", f"{min_pieces} and {max_pieces}")

  def get_scbst(self, status):
    result = len([lego_set for lego_set in self.set_list if lego_set.status == status])
    return self.count_results_check(result, "status", status)
