import ooomutils
from vault_backend.input_handlers.error_handler import (
    MenuError,
    Validator500000000,
    NoSetsFoundError,
)
    ...
    menu = MenuDisplay(
        ...
        [
            MenuPage(
                ...
                [
                    "1. Add a Owned set",
                    "2. Remove a Owned set",
                    "3. Display all Owned sets",
                    "4. Update a Owned set",
        ...
        try:
            ...
            # --- Page 2: Search Sets ---
                ...
                if choice == "1":
                    ...
                    sets = (
                        vault_manager.get_sbnum(sfs)
                        if isinstance(sfs, int)
                        else vault_manager.get_sbn(sfs)
                    )
                    for lego_set in sets:
                        print(lego_set.display())
